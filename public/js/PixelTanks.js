class PixelTanks {
  ...
  static boot() {
    ...
    PixelTanks.socket = new MegaSocket(window.location.protocol === 'https:' ? 'wss://'+window.location.hostname : 'ws://129.146.45.71:443', {keepAlive: true, reconnect: true, autoconnect: true});
  }

  ...
  collision() {
    for (const cell of this.cells) {
      ...
      for (const e of [...this.host.cells[c[0]][c[1]]].sort((a, b) => this.score(a) - this.score(b))) {
        ...
        if (((e instanceof Block && e.c) || ((e instanceof Tank || e instanceof AI) && !e.ded && Engine.getUsername(e.team) !== Engine.getUsername(this.team)) && Engine.collision(this.x, this.y, 10, 10, e.x, e.y, size, size)) return this.collide(e);
      }
    }
    return false;
  }

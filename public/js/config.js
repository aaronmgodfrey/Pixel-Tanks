window.sourceMap = {
  ...
  cosmetic: {
    path: 'cosmetics',
    common: ['bald', 'medic', 'police', 'log', 'small_scratch', 'spikes', 'moustache', 'pumpkin_face', 'army', 'hardhat', 'halo', 'lego', 'present', 'pumpkin_hat', 'top_hat', 'stamp', 'dead', 'earmuffs', 'ban', 'sweat', 'lava', 'bricks'],
    uncommon: ['camo', 'mold','scarred', 'block', 'chip', 'deep_scratch', 'evil_eye', 'inferno_eye', 'motherboard', 'blue_wings', 'blue_horns', 'white_wings', 'white_horns', 'gold_wings', 'gold_horns', 'devil_wings', 'devil_horns', 'hazard', 'angel_wings', 'bat_wings', 'locked', 'mini_tank', 'dust', 'pouch'],
    ...
    legendary: ['plasma', 'cry', 'missing', 'hoodie', 'galaxy', 'smoke'],
    admin: [],

window.sourceMap = {
  ...
  cosmetic: {
    ...
    uncommon: ['solider', 'feesh', 'knight', 'mango', 'camo', 'ripped', 'scarred', 'block', 'chip', 'deep_scratch', 'evil_eye', 'inferno_eye', 'motherboard', 'blue_wings', 'blue_horns', 'white_wings', 'white_horns', 'gold_wings', 'gold_horns', 'devil_wings', 'devil_horns', 'hazard', 'angel_wings', 'bat_wings', 'locked', 'mini_tank', 'dust', 'pouch'],
    rare: ['the_swift_crown', 'flowers', 'fives', 'fivehalf', 'nvg', 'cracked', 'blue_tint', 'glitch', 'blue_helmet', 'white_helmet', 'helmet', 'gold_helmet', 'hacker_hoodie', 'purple', 'visor', 'veins', 'cookie', 'splattered'],
    ...
    admin: [],
    mythic: ['terminator', 'mlg_glasses', 'corrupted', 'blood_rabbit', 'demon_goat'],
    meta: {},
  },
  deathEffect: {
    path: 'animations',

window.sourceMap = {
  ...
  cosmetic: {
    ...
    uncommon: ['soldier', 'feesh', 'knight', 'mango', 'camo', 'ripped', 'scarred', 'block', 'chip', 'deep_scratch', 'evil_eye', 'inferno_eye', 'motherboard', 'blue_wings', 'blue_horns', 'white_wings', 'white_horns', 'gold_wings', 'gold_horns', 'devil_wings', 'devil_horns', 'hazard', 'angel_wings', 'bat_wings', 'locked', 'mini_tank', 'dust', 'pouch'],

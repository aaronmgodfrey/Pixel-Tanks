class Client {
  ...
  frame() {
    ...
    if (Math.abs(br-this.tank.baseRotation) > Math.abs(br+180-this.tank.baseRotation) || Math.abs(br-this.tank.baseRotation) > Math.abs(br-180-this.tank.baseRotation)) br = (br+180+360)%360;

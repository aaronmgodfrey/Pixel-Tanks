...
let sockets = new Set(), servers = {}, ffaLevels = [
  ...
  [1,'deep',''],
...
const Commands = {
  ...
  crate: [FFA, 2, -1, (data, socket, server) => {
    for (let y = 0; y < 60; y++) for (let x = 0; x < 60; x++) server.b.push(A.template('Block').init(x*100-50, y*100-50, 'crate', undefined, server));
  }],
